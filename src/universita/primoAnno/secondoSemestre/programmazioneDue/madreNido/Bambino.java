...
import universita.primoAnno.secondoSemestre.programmazioneDue.madreNido.Braccialetto;
import universita.primoAnno.secondoSemestre.programmazioneDue.madreNido.OperazioneNonConsentitaException;
import universita.primoAnno.secondoSemestre.programmazioneDue.madreNido.Persona;
...
public class Bambino extends Persona {
	 ...
	 * Lancia eccezione se il braccialetto � null, il peso alla nascita e la lunghezza sono minori od ugiali a zero e 
	 ...
	 * @param quantitaLatte La quantit� di latte 
	 * */
	...
	/**
	 * Valuta se il bambino � dimettibile effettuando un controllo sui parametri del bambino
	 * @return true se il bambino � dimettibile, false in caso contrario
	 * */
